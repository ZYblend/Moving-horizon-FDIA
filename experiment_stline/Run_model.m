...
%% parameter
% d  = 0.042;                        % distance betwen medium point of axis of wheels and center of mass(m)
d  = 0.0562; % perfect 
% d  = 0.0177;
...
% Ts = 0.01;  % (s)
T_final = 25;
T_start_attack = .24*T_final;  % Time to begin attack
...
% T_start_attack = .05*T_final;  % Time to begin attack
